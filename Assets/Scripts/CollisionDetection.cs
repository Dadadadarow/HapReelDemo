...
public class CollisionDetection : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        {
            dataSender.SendMotorControlPacket(3,0.2f, 30, 0.0f, 50f, 10.0f);
            Debug.Log("Detect 0");
        }
        else if (-0.06f <= localCollisionPoint.x && localCollisionPoint.x < -0.02f)
        {
            dataSender.SendMotorControlPacket(3, 0.2f, 15, 0.0f, 50f, 10.0f);
            Debug.Log("Detect 1");
        }
        ...
        {
            dataSender.SendMotorControlPacket(4, 0.2f, 30, 0.0f, 50f, 10.0f);
            Debug.Log("Detect 4");
        }
    }
}
